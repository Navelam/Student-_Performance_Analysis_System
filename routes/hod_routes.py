...
def dashboard():
    ...
    return render_template('hod/dashboard.html',
                         ...
                         notifications=notifications)  # ← This was missing!
...
def risk_levels():
    ...
    if selected_semester != 'all':
        students_query = students_query.filter(Student.current_semester == int(selected_semester))
...
def student_performance():
    ...
    # Create mapping of subject_id to teacher
    subject_teacher_map = {}
    teacher_info_cache = {}
...
def import_students():
    ...
    if request.method == 'POST':
        ...
        for line in lines:
            ...
            # This is simplified - you'd need full implementation
            imported += 1
