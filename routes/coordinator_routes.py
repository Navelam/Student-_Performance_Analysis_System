...
from model import (
    ...
    InvigilatorAssignment, Notification, Semester, Course, AcademicYear
)
...
def create_notification(title, message, notification_type, target_role, user_id=None, end_date=None):
